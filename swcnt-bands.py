...
cnt1.calculateElectronBands('TB', 'TB5', sym='hel', gamma=5.0)
cnt1.calculateElectronBands('TB', 'TB2', sym='hel', gamma=2.0)
cnt1.calculateElectronBands('TB', 'TB3.5', sym='hel', gamma=3.5)
