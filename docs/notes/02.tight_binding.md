...
\begin{split}
S^{\mathbf{k}}_ {ij} &= \langle \chi_{i \mathbf{k}}|\chi_{j \mathbf{k}} \rangle =
\int_{cell} \chi^\ast_{i \mathbf{k}}(\mathbf{r}) \, \chi_{j \mathbf{k}}(\mathbf{r}) d\mathbf{r} \\
...
\int_{cell} \phi^\ast_{i}(\mathbf{r} - \mathbf{R}') \, \phi_{j}(\mathbf{r} - \mathbf{R}) d\mathbf{r},
\quad \mathbf{r} \rightarrow \mathbf{r} - \mathbf{R}' \\
&= \lambda_{i}^{\mathbf{k}*} \lambda_{j}^{\mathbf{k}} e^{i \mathbf{k} \cdot (\mathbf{t}_ {j} - \mathbf{t}_ {i})}
\sum_{\mathbf{R}, \mathbf{R}'}
e^{i\mathbf{k} \cdot (\mathbf{R} - \mathbf{R}')}
\int_{cell} \phi^\ast_{i}(\mathbf{r}) \, \phi_{j}(\mathbf{r} - (\mathbf{R} - \mathbf{R}')) d\mathbf{r},
\quad \mathbf{R} \rightarrow \mathbf{R} - \mathbf{R}' \\
&= \lambda_{i}^{\mathbf{k}*} \lambda_{j}^{\mathbf{k}} \, N \, e^{i \mathbf{k} \cdot (\mathbf{t}_ {j} - \mathbf{t}_ {i})}
\sum_{\mathbf{R}}
e^{i\mathbf{k} \cdot \mathbf{R}}
\int_{cell} \phi^\ast_{i}(\mathbf{r}) \, \phi_{j}(\mathbf{r} - \mathbf{R}) d\mathbf{r} \\
&= \lambda_{i}^{\mathbf{k}*} \lambda_{j}^{\mathbf{k}} \, N \, e^{i \mathbf{k} \cdot (\mathbf{t}_ {j} - \mathbf{t}_ {i})}
\sum_{\mathbf{R}}
e^{i\mathbf{k} \cdot \mathbf{R}}
S_{ij}(\mathbf{R}),
